...
export default function MissionRowSkeleton() {
  return (
    <li
      aria-hidden="true"
      className="flex animate-pulse items-center gap-3.5 rounded-2xl bg-brand-white p-4 shadow-sm"
    >
      <div className="h-10 w-10 shrink-0 rounded-xl bg-brand-track" />
      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
        <div className="h-6 w-1/2 rounded bg-brand-track" />
        <div className="h-5 w-3/4 rounded bg-brand-track" />
      </div>
      <div className="h-6 w-6 shrink-0 rounded-full bg-brand-track" />
    </li>
  );
}
