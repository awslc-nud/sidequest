 ...
 *
 * Establishes the mint-to-white page gradient (`ui-spec.md` §1.3, started on
 * `brand-track` so `UnderwaterBackdrop`'s white sun shafts have something to
 * read against) and clips overflow so nothing can introduce horizontal scroll
 * on narrow (375px) viewports.
 *
...
export default function AppShell({ children }: AppShellProps) {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-brand-track via-brand-bg to-brand-white">
