interface EventHeaderProps {
  ...
  title: string;
  /** Date + venue line, e.g. "Aug 28 - 29, 2025 • Main Campus". */
  subtitle: string;
}
 ...
 * weight are set explicitly. `ui-spec.md` does not define a type scale for the
 * header, so `text-2xl`/`text-sm` are used as mobile-appropriate defaults.
 */
